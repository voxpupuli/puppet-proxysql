# @summary Installs and configures ProxySQL
#
...
# @param listen_ip
#   The ip where the ProxySQL service will listen on. By default will listen on all IPs.
# @param listen_port
...
# @param sys_group
#   Group of the datadir and config_file. Defaults to value of `sys_owner`.
...
class proxysql (
  ...
  String $datadir = '/var/lib/proxysql',
